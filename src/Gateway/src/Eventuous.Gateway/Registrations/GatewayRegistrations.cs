...
public static class GatewayRegistrations {
    ...
    extension(IServiceCollection services) {
        ...
        /// <returns></returns>
        public IServiceCollection AddGateway<TSubscription, TSubscriptionOptions, TProducer, TProduceOptions>(
            ...
            services.AddSubscription<TSubscription, TSubscriptionOptions>(
                ...
                builder => {
                    ...
                    builder.AddEventHandler(sp => new GatewayHandler<TProduceOptions>(
        ...
        /// <returns></returns>
        public IServiceCollection AddGateway<TSubscription, TSubscriptionOptions, TProducer, TProduceOptions, TTransform>(
                string                                                            subscriptionId,
                Action<TSubscriptionOptions>?                                     configureSubscription = null,
                Action<SubscriptionBuilder<TSubscription, TSubscriptionOptions>>? configureBuilder      = null,
                bool                                                              awaitProduce          = true
