...
public static class AggregateFactoryContainerExtensions {
    ...
    extension(IServiceCollection services) {
        ...
        /// <returns></returns>
        public IServiceCollection AddAggregate<T, TState>(Func<IServiceProvider, T> createInstance)
        ...
        /// <typeparam name="TState">Aggregate state type</typeparam>
        /// <returns></returns>
        public IServiceCollection AddAggregate<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T, TState>() where T : Aggregate<TState> where TState : State<TState>, new() {
            services.TryAddSingleton<AggregateFactoryRegistry>();
