...
:::note
This page describes command services that work with [aggregates](../domain/aggregate.md). If you are not using aggregates, check the [Functional services](func-service.md) page.
:::
