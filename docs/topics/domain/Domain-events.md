<card-summary>
Domain events: facts, immutable state transitions, domain objects that describe behaviour of the model. Storing domain events instead of mutating state in a database is the essence of Event Sourcing.
</card-summary>
# Domain events
...
When talking about Event Sourcing, we focus on the last bit: _"making explicit the events [...], which are associated with state changes."_ Event Sourcing takes this definition further, and suggests:
