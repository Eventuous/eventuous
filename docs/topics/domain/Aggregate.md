<card-summary>
Aggregate pattern is one of Domain-Driven Design tactical patterns.
Find out about abstractions Eventuous provides to implement the pattern, with samples.
</card-summary>
# Aggregate
