<card-summary>Domain events: persisted behaviour</card-summary>
...
So, what this page is about? It doesn't look like a conventional documentation page, does it? Nevertheless, let's see how a domain event looks like when you build a system with Eventuous.

<code-block lang="c#" src="../../samples/esdb/Bookings.Domain/Bookings/BookingEvents.cs" include-lines="9-19"/>
